...
import {AppBar,Box,Toolbar,IconButton,Typography,Menu,MenuItem,
    Container,Avatar,Button,Tooltip} from '@mui/material';
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              ...
              {userInfo?(""):(<><MenuItem >
              <Link to={"/login"}style={{textDecoration:'none'}}><Typography> Sign iin</Typography></Link>
              </MenuItem>
              <MenuItem >
              <Link to={"/register"}style={{textDecoration:'none'}}><Typography> Sign up</Typography></Link>
              </MenuItem>
              </>)}
              {userInfo?<MenuItem >
              <Link style={{textDecoration:'none'}}><Typography onClick={logoutHandler}> Logout</Typography></Link>
              </MenuItem>:("")}
