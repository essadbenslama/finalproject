  ...
  <Modal show={show} onHide={handleClose} >
    ...
    <Form >
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Enter title" name="movieTitle"
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        ...
        <Form.Control type="text" placeholder="..." name="descreption"
         onChange={changeHandler}  />
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>PosterUrl</Form.Label>
        <Form.Control type="text" placeholder="..." name="posterUrl"
         onChange={changeHandler}  />
      </Form.Group>

      <Form.Group className="mb-3" >
        <Form.Label>trailler</Form.Label>
        <Form.Control type="text" placeholder="..." name="trailler" 
         onChange={changeHandler} />
      </Form.Group>
